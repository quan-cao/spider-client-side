...
- Step 1: Contact Mr. Quan Cao via Telegram @quancao to create account.

- Step 2: Start conversation with @quanvc_pabot. This will allow bot will notify you new posts later.
...
- Step 3: Click on Start Scraping.
